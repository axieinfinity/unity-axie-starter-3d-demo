...
public class TrackManager : MonoBehaviour
{
    ...
    {
        characterController.character.animController.PlayAnim(AxieStarter3D.StarterAnimController.AnimName.Idle);
    ...
    private IEnumerator IeContinue()
    {
        yield return new WaitForSeconds(3f);
        StartMove(false);
        player.animController.PlayAnim(AxieStarter3D.StarterAnimController.AnimName.Run);
    }
